...
「實務曾三次停在 `📦已合併` 留下假活卡」；2026-08-24 實測**四張卡正停在該值**，
...
3. **不回填既有 188 張卡的簡介**——回填本身要另開卡，且 ⛔ 未驗證簡介對 AI 判斷相關性的實效。
...
終態卡以 `archiveProjectV2Item` 移出活卡視圖。2026-08-24 實測 Project 4 共 188 個 item
中 127 個是終態，佔 **68%**。⛔ **維護卡不封存**——那會重演「交付後沒人看」。
