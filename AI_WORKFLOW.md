...
⚠️ 實得 **10 行對應 9 句**——第 4、5 行同屬第 4 句（該句因加註今日逃生門而跨兩行）。
...
| 6 | §6.4.1 未驗清單每項須標明驗不了的原因 | ⛔ 無。承接者＝查核者人工審 | 重演 `aiwf#129` R2：寫下「未驗」而其實兩分鐘可驗 |
| 7 | §6.4.1 標不出原因者不得列入 | ⛔ 無，同上 | 同上 |
| 8 | §6.4.1 兩種「未驗」須分開 | ⛔ 無，同上 | 「驗不了」與「沒去驗」混為一談，揭露變成免責聲明 |
