...
| `data-migration` | read-only | `AI_WORKFLOW.md:124`<br>`AI_WORKFLOW.md:156` | — | `cli/src/wf_cli/commands/open_cmd.py:81`<br>`cli/src/wf_cli/resources.py:39` | 相關動詞=無 |
...
| `escalation-epoch-change` | mention-only | `AI_WORKFLOW.md:143`<br>`templates/review-escalation.md:157`<br>`templates/review-escalation.md:159`<br>…共 9 | — | — | 相關動詞=無 |
...
| `handoff-accepted` | mention-only | `AI_WORKFLOW.md:144`<br>`templates/control-plane-contract.md:58`<br>`templates/handoff-contract.md:9`<br>…共 6 | — | — | 相關動詞=handoff |
...
| `review-correction` | mention-only | `AI_WORKFLOW.md:104`<br>`AI_WORKFLOW.md:143`<br>`templates/review-escalation.md:44`<br>…共 10 | — | — | 相關動詞=review |
| `review-invalid` | mention-only | `AI_WORKFLOW.md:103`<br>`AI_WORKFLOW.md:204`<br>`templates/review-escalation.md:11`<br>…共 8 | — | — | 相關動詞=review |
...
| `📦已合併` | read-only | `AI_WORKFLOW.md:18`<br>`AI_WORKFLOW.md:173`<br>`templates/TASKS.md:6`<br>…共 7 | — | `cli/src/wf_cli/doctor.py:1650`<br>`cli/src/wf_cli/project.py:40` | Project 選項=是；專責動詞=否；⚠️ 沒有專責動詞；只有自由文字旗標寫得進去（見報告的「自由文字狀態旗標」） |
...
| `🏁完成` | ok | `AI_WORKFLOW.md:18`<br>`templates/TASKS.md:6`<br>`templates/project-stub.md:25`<br>…共 6 | `cli/src/wf_cli/commands/assign_cmd.py:89`<br>`cli/src/wf_cli/commands/handoff_cmd.py:467`<br>`cli/src/wf_cli/doctor.py:1240` | `cli/src/wf_cli/commands/assign_cmd.py:89`<br>`cli/src/wf_cli/doctor.py:1240`<br>`cli/src/wf_cli/project.py:40` | Project 選項=是；專責動詞=是 |
| `💡需求` | ok | `AI_WORKFLOW.md:18`<br>`templates/TASKS.md:6` | `cli/src/wf_cli/commands/handoff_cmd.py:176`<br>`cli/src/wf_cli/doctor.py:1234` | `cli/src/wf_cli/commands/handoff_cmd.py:176`<br>`cli/src/wf_cli/doctor.py:1234`<br>`cli/src/wf_cli/project.py:39` | Project 選項=是；專責動詞=是 |
| `📥Backlog` | ok | `AI_WORKFLOW.md:18`<br>`AI_WORKFLOW.md:113`<br>`AI_WORKFLOW.md:118`<br>…共 4 | `cli/src/wf_cli/card.py:295`<br>`cli/src/wf_cli/commands/handoff_cmd.py:179`<br>`cli/src/wf_cli/doctor.py:1237`<br>…共 4 | `cli/src/wf_cli/commands/handoff_cmd.py:179`<br>`cli/src/wf_cli/doctor.py:1237`<br>`cli/src/wf_cli/project.py:39` | Project 選項=是；專責動詞=是 |
| `🔍待查核` | ok | `AI_WORKFLOW.md:18`<br>`templates/TASKS.md:6`<br>`templates/handoff-contract.md:154`<br>…共 6 | `cli/src/wf_cli/commands/handoff_cmd.py:181`<br>`cli/src/wf_cli/commands/review_cmd.py:104`<br>`cli/src/wf_cli/doctor.py:1239` | `cli/src/wf_cli/commands/handoff_cmd.py:181`<br>`cli/src/wf_cli/doctor.py:1239`<br>`cli/src/wf_cli/project.py:40` | Project 選項=是；專責動詞=是 |
| `🔨執行中` | ok | `AI_WORKFLOW.md:18`<br>`AI_WORKFLOW.md:118`<br>`templates/TASKS.md:6`<br>…共 6 | `cli/src/wf_cli/commands/assign_cmd.py:120`<br>`cli/src/wf_cli/commands/handoff_cmd.py:180`<br>`cli/src/wf_cli/doctor.py:1238` | `cli/src/wf_cli/commands/handoff_cmd.py:180`<br>`cli/src/wf_cli/doctor.py:1238`<br>`cli/src/wf_cli/project.py:39` | Project 選項=是；專責動詞=是 |
| `🔬研究中` | ok | `AI_WORKFLOW.md:18`<br>`templates/TASKS.md:6` | `cli/src/wf_cli/commands/handoff_cmd.py:177`<br>`cli/src/wf_cli/doctor.py:1235` | `cli/src/wf_cli/commands/handoff_cmd.py:177`<br>`cli/src/wf_cli/doctor.py:1235`<br>`cli/src/wf_cli/project.py:39` | Project 選項=是；專責動詞=是 |
...
| `🧭規劃中` | ok | `AI_WORKFLOW.md:18`<br>`AI_WORKFLOW.md:118`<br>`templates/TASKS.md:6` | `cli/src/wf_cli/commands/handoff_cmd.py:178`<br>`cli/src/wf_cli/doctor.py:1236` | `cli/src/wf_cli/commands/handoff_cmd.py:178`<br>`cli/src/wf_cli/doctor.py:1236`<br>`cli/src/wf_cli/project.py:39` | Project 選項=是；專責動詞=是 |
