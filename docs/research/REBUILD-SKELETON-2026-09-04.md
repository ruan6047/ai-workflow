...
硬擋淨數 **9**（乙案＋自審第二輪，2026-09-04）：平台委託 5（H1 H2 H3 H4 H12）、CLI 資料有效性 4（H7 轉移與終態、H9 入口、H10 JSON、H11＋KR 指向的 SHA 與留言存在）。判準只剩一句：**CLI 拒的只有「寫壞資料」與「指向不存在的東西」；其餘一律把資訊印出來，交 AI 或人判。**
