...
{"id":10,"prior":"待釐清","result":"真衝突","dim":"所有權粒度","edit":["roles/pm.md §2"],"falsifier":"共同情境＝執行者建立 .wf/stages/<階段>.md 後，PM 要動其中既有條目。規範效果互斥：roles/pm.md §4 F-PM-12「維護 .wf/stages/<階段>.md 與卡面 notes 只加條目」是義務，同檔 §2「只修自己的產出物」是禁止 ⇒ 同角色、同對象、義務對禁止。⚠️ 本卡核心痛點第 ③ 項是已發生的實撞，屬閱讀失效證據、⛔ 不單獨作為真衝突的充分理由（同 #22 的處置口徑）。推翻＝證明「維護」只涵蓋追加而不含改既有條目，使兩條可同時履行。"},
