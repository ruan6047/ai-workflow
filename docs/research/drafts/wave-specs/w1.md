...
3. （P1-30：本卡＝card-face JSON schema **唯一 owner**）sentinel 字面＝`<!-- card-face-form:v1:begin -->`／`<!-- card-face-form:v1:end -->`（⛔ 與 resource-claims 哨兵不同名、⛔ 不以「找到一個 JSON fence」定位）；schema（v1，additionalProperties=false，三 key 皆 required）：
```json
{"schema_version":"1",
 "stage_plan":[{"stage":"string(八階段名之一)","goal":"string"}],
 "tier_basis":{"sensitive_surfaces":"string","recoverability":"string","blast_radius":"string"},
 "list_convergence":[{"issue_url":"string","claim":"covers|related"}]}
```
