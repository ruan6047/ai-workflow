...
{"$schema":"https://json-schema.org/draft/2020-12/schema",
 ...
 "properties":{
  ...
  "list_convergence":{"type":"array","items":{"type":"object","additionalProperties":false,
    ...
    "properties":{"issue_url":{"type":"string","pattern":"^https://github\\.com/"},
                  "claim":{"enum":["covers","related"]}}}}}}
```
schema 外附加規則（validator 同步實作、各有拒收 fixture）：stage_plan 重複 stage 拒收；list_convergence 允許空陣列（卡可不涵蓋清單項）、重複 issue_url 拒收。
