...
**痛點（落差）**：開卡速率高於可證明的推進速率下界（2026-08-29 快照 10 日差分：開卡 5.2 張/日；推進 **≥**3.9 次/日——日差分吃掉同日多次轉移，⛔ 不宣稱嚴格不等式）；⭐ 承重證據＝2026-08-28 一天四張同族卡（開卡產生器實例）；open 允許直接建 issue 與 DraftIssue（實測板上有 1 張 DraftIssue）、--acceptance 可為空、--core-pain 只驗非空。
