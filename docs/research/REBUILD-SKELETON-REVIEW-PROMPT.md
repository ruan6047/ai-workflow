...
- **R3 內容**：§四轉移表有沒有死角（某狀態進得去出不來）？§六 schema 有沒有欄位是 CLI 讀不到卻要它驗的？§七的七個動詞的硬擋有沒有超出 §三重判表所列各條、或落在資料有效性／寫入順序／平台委託三類之外？
- **R4 影響面**：§十三順序與停損能不能執行；§十四的 5 條驗收條件你各自實測結果；§十五五題已裁定，只驗骨架有沒有照做；§十七詞表你認為缺哪些詞。
