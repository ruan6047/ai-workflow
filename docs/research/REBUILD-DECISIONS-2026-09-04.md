...
- **第零條與 C10 的關係**（需求方 2026-09-04 定第零條後、PM 據以重判、Codex R1-01 要求回寫）：第零條取代 C10「20 條」的計數；硬擋只落在資料有效性、寫入順序、平台委託三類，逐條重判表以骨架 §三為唯一清單。⚠️ 此行由 PM 依第零條推導補寫，需求方 sign-off 時一併確認。
