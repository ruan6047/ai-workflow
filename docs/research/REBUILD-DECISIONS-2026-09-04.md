...
- **統計結果解讀通則的居所**（需求方 2026-09-06 甲案）：04#138「第 7、9、10 條適用所有研究結論，不限紅線卡」與決策 4「條件不成立就不存在」衝突；裁定三條通則落 `roles/executor.md` §4（誰下結論誰適用），`modules/stat-redline` 保留紅線卡的具體化版本並指向；骨架 §九 stat-redline 列同步註記。
