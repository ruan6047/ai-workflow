...
|---|---|---|---|---|---|---|---|---|---|
| [WF-19](tasks/WF-19.md) | — | T2 | discovery-brief 對抗式質詢建議欄 | 待指派（校讀） | `ai/fable-5/WF-19` | 0 | 🔍待查核 | —不適用 | 2026-07-26T20:13:00+08:00 |

## 依賴註記（相關卡）

> 規劃／大卡分切時據此判定連動範圍（取代逐卡 `[[]]`；結案卡見 archive）。

- _（無活卡）_（WF-18 已結案；採用同步＋F-01 歷史補帳由 cpbl-analytics DOC-WORKFLOW-ADOPT2 承接）
